...
class PDFHighlighterApp:
    ...
    def create_ui(self):
        ...
        tk.Label(top_frame, text="Lines per Iteration:").grid(row=0, column=1, padx=5)
        ...
        # Delay Input
        tk.Label(top_frame, text="Delay (seconds):").grid(row=0, column=3, padx=5)
        ...
        self.text_label.grid(row=2, column=0, sticky='ew', padx=10, pady=5)
    ...
    def update_text(self):
        """
        Update the text label with PDF lines
        """
